  ...
  return (
    <div className="flex sticky top-0 w-full  flex-row ">
      ...
      <div className="bg-transparent h-fit flex flex-col w-full m-5  pt-[5vh] rounded-xl">
        ...
        />
        <div className="font-bold text-black text-left text-2xl	 py-4 px-4">
          {user.fullName}
        </div>
        <div className="flex flex-col gap-3">
          <div className="flex flex-row px-4 gap-3">
            {/* <div className="text-black text-left 	">Username :</div> */}
            <div className="text-black text-left text-sm text-slate-600 font-normal ">
              @{user.username}
            </div>
          </div>
          <div className="flex flex-row px-4 gap-3">
      ...
      <FlamesComponent/>
        ...
        <div className="px-4 mt-8 mb-4 text-sm text-black">SnipShelf API Token :</div>
