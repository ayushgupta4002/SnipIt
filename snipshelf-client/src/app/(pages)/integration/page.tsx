      ...
      <div className="flex flex-col mt-7 mx-[13vw] ">
        ...
        <div className="mx-[4vw] my-[3vh]">
          <ol className="list-decimal gap-3">
            ...
            <div className="font-normal text-lg font-sans mt-3">Press F1 or <span className="border p-1 bg-slate-100 border-slate-400 rounded-lg">CMD + Shift + P</span> and type install. Pick Extensions:
            ...
            <li className="text-xl mt-5">
              ...
              <div className="font-normal text-lg font-sans mt-3">
                press <span className="border p-1 bg-slate-100 border-slate-400 rounded-lg">CMD + Shift + P</span> and type <code className="border p-1 bg-slate-100 border-slate-400 rounded-lg">snip:auth</code>
        ...
        <div className="mx-[4vw] my-[3vh] flex flex-col gap-2  ">
          <ol className="list-decimal w-[57vw] ">
            <li className="text-xl mt-5">
              ...
              <div className="font-normal text-lg font-sans mt-3">
                Select any snippet that you want to save and press <span className="border p-1 bg-slate-100 border-slate-400 rounded-lg">CMD + Shift + P</span> and type <code  className="border p-1 bg-slate-100 border-slate-400 rounded-lg">snip:push</code>
            ...
            <li className="text-xl pt-[4vh]">
              ...
              <div className="font-normal text-lg font-sans mt-3">
                Press <span className="border p-1 bg-slate-100 border-slate-400 rounded-lg">CMD + Shift + P</span>  and type <code className="border p-1 bg-slate-100 border-slate-400 rounded-lg">snip:pull</code>
                <Image src={"/snip-pull.jpg"} width={700} height={300} alt="Welcome!"  className="mt-5"/>

              </div>
              <div className="font-normal text-lg  font-sans mt-4 mb-4">
                Select a Name for your Snippet or cChoose one from the list and Press <code className="border p-1 bg-slate-100 border-slate-400 rounded-lg">Enter</code>,congratulations! your have your sinppet in the file !
